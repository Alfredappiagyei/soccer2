                ...
                <div className="jonathan">
                    <div className="container"  id="playerdetails">
                        <div className="col-md-6 col-xs-12">
                            <p id="jerseyNumber">1</p>
                            <p id="playerFirstName">Jonathan</p> 
                            <p id="playerSurName">Odoom</p>
                            <p>GOALKEEPER</p>                           
                        </div>
                        <div className="col-md-6 col-xs-12">
                            <h3>D.O.B <br /> <h2><b>22//2/2002</b></h2></h3>
                            <h3>Place of birth <br /> <h2><b>Adansi Wuyier</b></h2></h3>
                        ...
                        <div className="col-md-9 col-xs-12">
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6" style={{ display: "block", justifyContent: "center", color: "#fff", textAlign: "center", background: "#414141" }}>
                                    <span><p>Jonathan Odoom</p><b />Soccer Angels Academy</span>
                                </div>
                            </div>
