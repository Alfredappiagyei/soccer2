        ...
        return (
            <div>
                <div className="bright">
                    <div className="container" id="brightdetails">
                        <div className="col-md-6 col-xs-12">
                            <h1 style={{ fontSize: "80px", marginBottom: "20px" }}><b>99</b></h1>
                             <h1 style={{ fontSize: "50px" }}><b>Bright </b></h1> 
                            <h1 style={{ fontSize: "80px" }}><b>Appau</b></h1>
                            <h2>GOALKEEPER</h2>
                        </div>
                        <div className="col-md-6 col-xs-12">
                            <h3>D.O.B <br /> <h2><b>25/6/2004</b></h2></h3>
                        ...
                        <div className="col-md-9 col-xs-12">
                                ...
                                <nav class="navbar navbar-default" style={{ backgroundColor: '#333333', color: "#fff", }}>
                                    <div class="container-fluid">
                                        <div class="navbar-header">
                                            <Link to="/firstteam" className="navbar-brand" style={{ color: "#fff", font: "22px sans serif", background: "lawngreen" }}><b>Bright</b> </Link>
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6" style={{ display: "block", justifyContent: "center", color: "#fff", textAlign: "center", background: "#414141" }}>
                                    <span><p>Bright Appau</p><b />Soccer Angels Academy</span>
                                </div>
                            </div>
