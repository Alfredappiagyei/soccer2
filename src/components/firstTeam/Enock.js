                ...
                <div className="enock">
                    <div className="container" id="enockdetails">
                        ...
                        <div className="col-md-6 col-xs-12">
                            ...
                            <h3>Place of birth <br /> <h2><b>Assin Fosu</b></h2></h3>
                                ...
                                <nav className="navbar navbar-default" style={{ backgroundColor: '#333333', color: "#fff", }}>
                                    <div className="container-fluid">
                                        <div className="navbar-header">
                                            <Link to="/firstteam" className="navbar-brand" style={{ color: "#fff", font: "22px sans serif", background: "lawngreen" }}><b>Enock</b> </Link>
