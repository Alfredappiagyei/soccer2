                ...
                <div className="elvis">
                    <div className="container" id="elvisdetails">
                        <div className="col-md-6 col-xs-12">
                            ...
                            <h1 style={{ fontSize: "80px" }}><b>Botwe</b></h1>
                            <h2>DEFENDER</h2>
                        </div>
                        <div className="col-md-6 col-xs-12">
                        ...
                        <div className="col-md-9 col-xs-12">
                                ...
                                <nav class="navbar navbar-default" style={{ backgroundColor: '#333333', color: "#fff", }}>
                                    <div class="container-fluid">
                                        <div class="navbar-header">
                                            <Link to="/firstteam" className="navbar-brand" style={{ color: "#fff", font: "22px sans serif", background: "lawngreen" }}><b>Elvis</b> </Link>
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6" style={{ display: "block", justifyContent: "center", color: "#fff", textAlign: "center", background: "#414141" }}>
                                    <span><p>Elvis</p><b />Soccer Angels Academy</span>
                                </div>
                            </div>
